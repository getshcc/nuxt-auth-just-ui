...
<template>
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                <h2 class="text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Register your account
                </h2>
            </div>
            ...
            <div class="mt-10 mb-10 sm:mx-auto sm:w-full sm:max-w-sm ">
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div>
                        <p class="text-sm">if you have an account <NuxtLink to="/account/login" class="text-indigo-600">
                                Login</NuxtLink>
                        </p>
                    </div>
